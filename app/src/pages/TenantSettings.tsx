      ...
      try {
        ...
        if (config.settings) {
          ...
          const settingsWithDefaults = {
            ...
            zelle_number: zelleNumberFromApi(config.settings.zelle_number),

            zelle_email: zelleEmailFromApi(config.settings.zelle_email),
            ...
            config: {
              ...
              booking: {
                ...
                allowed_payment_method: normalizeAllowedPaymentMethodMap(
                  ...
                  config.settings.config?.booking?.allowed_payment_method
        ...
        <div className="bw-card" style={{ 
          ...
          <div style={{ marginBottom: 'clamp(24px, 4vw, 32px)', borderTop: '1px solid var(--bw-border)', paddingTop: 'clamp(24px, 4vw, 32px)' }}>
            ...
            <div className="bw-form-grid" style={{ 
              ...
              {RIDER_PAYMENT_METHOD_IDS.map((methodId) => (

                <div key={methodId} className="bw-form-group" style={{ width: '100%', minWidth: 0 }}>
              ...
              <div className="bw-form-group" style={{
                ...
                <p style={{
                  ...
                  When <strong>Offer Zelle</strong> is yes, riders see these payout details in a short message after they choose Zelle so they know where to send payment.
              ...
              <div className="bw-form-group" style={{ width: '100%', minWidth: 0 }}>
                ...
                {editingBookingConfig ? (
                  ...
                  (() => {
                    ...
                    const zellePhoneErr = zellePhoneValidationError(editedSettings?.zelle_number)
                  ...
                  <input
                    ...
                    value={editedSettings?.zelle_number ?? ''}

                    onChange={(e) => {

                      const formatted = formatUsPhoneInput(e.target.value)

                      handleSettingChange('zelle_number', formatted === '' ? null : formatted)

                    }}

                    placeholder="(555) 123-4567"

                    aria-invalid={zellePhoneErr != null}
                    ...
                    style={{
                      ...
                      border: zellePhoneErr ? '1px solid #b91c1c' : '1px solid var(--bw-border)'
                  ...
                  <p style={{
                    ...
                    US numbers only: 10 digits, formatted automatically.
              ...
              <div className="bw-form-group" style={{ width: '100%', minWidth: 0 }}>
                ...
                {editingBookingConfig ? (
                  ...
                  <input
                    ...
                    value={editedSettings?.zelle_email ?? ''}
                  ...
                  <span className="bw-info-value" style={{
                    ...
                    {zelleEmailFromApi(tenantConfig.settings?.zelle_email) ?? '—'}
